...
//   @d
//   m=-1
//   if d=endscreen jmp white
//   d++
//   jmp whiteing


@KBD  // endofscreen=kbd-1
D=A-1
@endofscreen
M=D
...
(TURN_BLACK)
  ...
  @endofscreen  // if pixel=endofscreen jmp  black
  D=M
  @pixel
  D=D-M
  @BLACK
...
(TURN_WHITE)
  ...
  @endofscreen  // if pixel=endofscreen jmp white
  D=M
  @pixel
  D=D-M
  @WHITE
